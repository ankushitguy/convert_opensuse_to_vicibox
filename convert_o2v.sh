...
# This script was referenced from https://download.vicidial.com/vicibox/opensuse15_3-vicibox-bootstrap.sh
...
$ZYPPER addrepo --refresh --keep-packages --no-gpgcheck https://download.opensuse.org/repositories/home:/vicidial:/asterisk-16/openSUSE_Leap_15.5/ openSUSE-Leap-15.5-ViciDial-Ast16
$ZYPPER addrepo --refresh --keep-packages --no-gpgcheck https://download.opensuse.org/repositories/home:/vicidial:/vicibox/openSUSE_Leap_15.5/ openSUSE-Leap-15.5-ViciDial-ViciBox
$ZYPPER addrepo --refresh --keep-packages --no-gpgcheck https://download.opensuse.org/repositories/home:/vicidial/openSUSE_Leap_15.5/ openSUSE-Leap-15.5-ViciDial
$ZYPPER addrepo --refresh --keep-packages --no-gpgcheck https://download.opensuse.org/repositories/devel:/languages:/perl/15.5/ openSUSE-Leap-15.5-PERL
$ZYPPER --gpg-auto-import-keys refresh
$ZYPPER --non-interactive in -t pattern lamp_server
$ZYPPER --non-interactive in libjansson4
$ZYPPER --non-interactive in adaptec-firmware aggregate apache2-mod_cband asterisk-dahdi bmon ddclient dhcp-client digitemp extundelete fonts-config git gnu_ddrescue htop iftop iotop iprelay iptraf-ng lame lshw lvm2 memtest86+ mlocate mpt-firmware mtop mtr mydumper mytop ncftp net-tools-deprecated ngrep-sip nmap numad ntp openr2 OpenIPMI patch pcapsipdump perl-MIME-Lite perl-Net-SFTP-Foreign perl-MySQL-Diff perl-Term-ANSIColor phpMyAdmin php7-opcache php7-cli pico ploticus recode sensord sensors sipp shim sngrep sshfs stress-ng sysstat tcpdump telnet vicibox-dynportal vicibox-firewall vicibox-install vicibox-ssl vsftpd zip
